 ...
 */
public class FiberAsyncHttpClientTest {
    ...
    private static void test() throws InterruptedException, ExecutionException, TimeoutException, IOException {
        final FiberAsyncHttpClient fiberAsyncHttpClient = new FiberAsyncHttpClient();
        Fiber fiber = null;
        try {
            fiber = new Fiber<String>() {
                ...
                protected String run() throws SuspendExecution, InterruptedException {
                    ...
                    try {
                        ...
                        response = fiberAsyncHttpClient.executeGet("http://jsonplaceholder.typicode.com/users?id=1");
